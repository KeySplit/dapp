    ...
    render() {
        return (
            <div className="privacy">
                ...
                <p>Last Update: February 17, 2018</p><br/>
                <p>
                    1. Introduction<br/>
                    1.1 KeySplit recognizes that people who use KeySplit value their privacy. This Privacy Policy details important information regarding the collection, use and disclosure of User information collected on the KeySplit website located at https://keysplit.io/ (the “Site”), and any other features, tools, materials, or other services (including co-branded or affiliated services) offered from time to time by KeySplit (the “Service”). KeySplit provides this Privacy Policy to help you understand how your personal information is used by us and your choices regarding our use of it.<br/>
                    ...
                    <br/>
                    1.4 Any questions, comments or complaints that you might have should be emailed to privacy@keysplit.io.
                </p>
                ...
                <p>
                    ...
                    <br/>
                    2.2 Your first wallet address created through the KeySplit plugin becomes publicly known to us. We receive only the public address and the address is sent to our server. We do not receive information from subsequent wallet creations through the Service.
                    <br/>
                ...
                <p>
                    3. The Way KeySplit Uses Your Personal Information
                    <br/>
                ...
                <p>
                    ...
                    <br/>
                    4.2 KeySplit also reserves the right to disclose personal information that MetaMask believes, in good faith, is appropriate or necessary to enforce our Terms of Use, take precautions against liability or harm, to investigate and respond to third-party claims or allegations, to respond to a court orders or official requests, to protect the security or integrity of our Service,and to protect the rights, property, or safety of KeySplit , our users or others.
                    <br/>
                    4.3 In the event that KeySplit is involved in a merger, acquisition, sale, bankruptcy, insolvency, reorganization, receivership, assignment for the benefit of creditors, or the application of laws or equitable principles affecting creditors’ rights generally, or other change of control, there may be a disclosure of your information to another entity related to such event.
                </p>

                <p>
                    5. Your Choices
                    <br/>
                    5.1 KeySplit will process your personal information in accordance with this Privacy Policy, and as part of that you will have limited or no opportunity to otherwise modify how your information is used by KeySplit.
                </p>

                <p>
                    6. Cookies
                    <br/>
                    6.1 KeySplit does not use cookies at this time but reserves the right to do so in the future. These terms shall be updated accordingly.
                </p>
                ...
                <p>
                    ...
                    <br/>
                    9.2 Contact Information: privacy@keysplit.io
                </p>
            </div>
        )
    }
