            ...
            <div className="step2">
                ...
                <div className="fl-row">
                    <div className="fl-offset-5 fl-90">
                        ...
                        <input onChange={ this.handleInputChange.bind(this, 1, "community")} placeholder="Community (school, work, etc.)" type="text" name="g1_community" />
                    </div>
                </div>
                <div className="fl-row">
                    <div className="fl-offset-5 fl-90">
                        ...
                        <input onChange={ this.handleInputChange.bind(this, 2, "community") } placeholder="Community (school, work, etc.)" type="text" name="g2_community" />
                    </div>
                </div>
                <div className="fl-row">
                    <div className="fl-offset-5 fl-90">
                        ...
                        <input onChange={ this.handleInputChange.bind(this, 3, "community") } placeholder="Community (school, work, etc.)" type="text" name="g3_community" />
                    </div>
                </div>
                <div className="fl-row">
                    <div className="fl-offset-5 fl-90">
                        ...
                        <input onChange={ this.handleInputChange.bind(this, 4, "community") } placeholder="Community (school, work, etc.)" type="text" name="g4_community" />
                    </div>
                </div>
                <div className="fl-row">
                    <div className="fl-offset-5 fl-90">
                        ...
                        <input onChange={ this.handleInputChange.bind(this, 5, "community") } placeholder="Community (school, work, etc.)" type="text" name="g5_community" />
                    </div>
                </div>
                <center>
                    <button
